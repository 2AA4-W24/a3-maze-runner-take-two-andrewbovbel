...
public class TremauxTest {
    ...
    void solvesRegularShortestPath() {
        Maze.Path path = tremaux.solve(regular);
    ...
    void solvesSmallShortestPath() {
        Maze.Path path = tremaux.solve(small);
